...
@api.route('/evil_cat', methods=['GET', 'POST'])
def fetchEvilCatFact():
    
    ebform = EvilCatFactForm()
    ...
    if request.method == 'POST':
        ...
        eb_search_input=EvilCatFact(eb_search)
            
        print(eb_search_input.refresh)
        data =''
        ...
        return render_template('evil_cat.html', form=ebform)
